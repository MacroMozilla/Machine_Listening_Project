...
from b_nn_model.c_nn_model import EmbeddingModel, RawFeatureExtractor, FeatureExtractor  # 🛠 注意：换成了EmbeddingModel！
    ...
    for machine in machines:
        ...
        for epoch in range(epochs):
            ...
            for domain, dataloader in zip(['source', 'target'], [test_loader_source, test_loader_target]):
                ...
                with torch.no_grad():
                    for x_BxTxF_val, y_B_val, att_BxAxD_val in tqdm(dataloader, desc=f"Eval-{machine} Epoch {epoch + 1}"):
